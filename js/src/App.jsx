  ...
  return (
    <div className={`app main-app ${theme}-theme`}>
      ...
      <footer className="app-footer">
        <p>
          Built with <a href="https://docs.xfloor.ai/javascript-sdk-1930593m0" target="_blank" rel="noopener noreferrer">xFloor JavaScript SDK</a>
        </p>
      </footer>
