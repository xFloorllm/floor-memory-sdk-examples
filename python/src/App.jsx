  ...
  return (
    <div className={`app main-app ${theme}-theme`}>
      <header className="app-header">
        <div className="header-content">
          <div className="header-title">
            <h1>xFloor Memory SDK Demo Python</h1>
      ...
      <footer className="app-footer">
        <p>
          Built with <a href="https://docs.xfloor.ai/python-sdk-1930592m0" target="_blank" rel="noopener noreferrer">xFloor Python SDK</a>
        </p>
      </footer>
